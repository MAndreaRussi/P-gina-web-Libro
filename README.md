...
- `images/` — portada, contratapa y foto de presentación del libro
  (mantené exactamente estos nombres, son los mismos que ya tenés en tu PC):
  - `b49c00ea-74ae-4380-95c4-a82e04760daf.jpeg` → tapa del libro
  - `7d435d92-073a-44f7-8d35-9f9c7bcd0f43.jpeg` → foto en Pan de Azúcar
  - `2ed4533e-8e80-479d-a059-fccc084603e6.jpeg` → contratapa del libro
